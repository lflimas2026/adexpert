...
export interface Campaign { id: string; user_id: string; platform: string; name: string; objective: string; status: string; budget_daily: number; start_date: string; end_date?: string; target_cpa?: number; metrics: CampaignMetrics; audiences?: any[]; placements?: any[]; creatives?: any[]; schedule?: any[]; keywords?: any[]; arquivada?: boolean; }
